    ...
    <section id="archive" aria-labelledby="archive-heading" className="mx-auto max-w-6xl px-5 py-8">
      <div className="border border-academic-line bg-academic-panel p-5 sm:p-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <p className="text-sm text-slate-600">Count checked <time dateTime={casebankArchive.updated}>12 September 2026</time></p>
        </div>
        ...
        <details id="count-method" className="mt-7 border-t border-academic-line pt-5">
          ...
          <div className="mt-5 space-y-4 text-sm leading-7 text-slate-600">
            ...
            <p><strong className="text-academic-navy">Video collections.</strong> The historical database holds {casebankArchive.historicalVideoCases} video case records linked to {formatArchiveCount(casebankArchive.historicalMediaRecords)} media-file records, including videos and images. The separate catalogue dated {casebankArchive.videoCatalogueSnapshot} holds {casebankArchive.videoCatalogueCases} case records and {casebankArchive.videoCatalogueFileLocations} listed video-file locations. Its earlier 83-case list is fully included and is not counted again. Multiple clips or file copies do not create additional cases.</p>
