...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "De-identified educational case frameworks for biportal endoscopic decompression, UBE-TLIF, revision endoscopic lumbar interbody fusion, adjacent segment disease, cervical spondylotic myelopathy, UBE-ULBD and biportal endoscopic TLIF for multilevel lumbar stenosis with L6 lumbarization, and UBE-TLIF for post-laminectomy recurrent stenosis and bilateral foraminal stenosis.",
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        title="Seven de-identified educational case frameworks"
